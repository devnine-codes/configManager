...
public class MultiValueMapConverter {
    public MultiValueMap<String, Object> multiValueMap;
    ...
    public MultiValueMap addMultiValueFromBean(MultiValueMap multiValueMap, String name, Object object) throws IntrospectionException, InvocationTargetException, IllegalAccessException, NoSuchMethodException {
